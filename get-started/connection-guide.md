...
1. Scroll down to "Popular" and tap on "MoonwalkerSwap". You can also find it in "Exchanges".

![](../.gitbook/assets/image%20%28138%29.png)

1. A new page will open with the MoonwalkerSwap logo and some information. Tap the **Connect** button.

![](../.gitbook/assets/image%20%28114%29.png)

1. MoonwalkerSwap will open up. If you see a **Connect** button in the top-right tap that and tap **Trust Wallet** from the list.
...
1. You'll see a DApp browser page open. Under "DeFi", find and tap the **MoonwalkerSwap** button. If you can't see MoonwalkerSwap under exchange, you can also find it under "BSC".

![](../.gitbook/assets/image%20%2854%29.png)

1. A window will open saying that you will be opening a third party DApp. Tap **Confirm** and you'll be taken to MoonwalkerSwap's website connected to your wallet.
...
1. Visit the [MoonwalkerSwap website](https:///). In the top right corner you'll see the **Connect** button. Click it.
