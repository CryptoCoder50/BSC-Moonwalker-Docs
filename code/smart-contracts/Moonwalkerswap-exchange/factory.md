...
{% hint style="warning" %}
MoonWalkerSwap is based on Uniswap v2. Read the [Uniswap v2 documentation](https://uniswap.org/docs/v2/).  
...
View [MoonwalkerFactory.sol on GitHub](https://github.com/MoonWalkerJim/New-Moonwalker-swap-core/blob/main/contracts/MoonwalkerFactory.sol).
